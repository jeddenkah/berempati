...
<div class="row justify-content-center">
    <div class="col-xl-8">
        <div class="card shadow">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('crowdfund.auction.store', $crowdfund->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" name="target_date" id="input-target-date" value="{{ old('target_date') }}">
