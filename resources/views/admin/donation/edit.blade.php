        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h3 class="mb-0">Edit Donation</h3>
                    </div>
                </div>
            </div>
            @if ($errors->any())
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('crowdfund.donation.update', [$crowdfund->id, $donation->id]) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="input-nominal" class="form-control" name="nominal"
                                            placeholder="Nominal" value="{{ $donation->nominal }}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="message" class="form-control" id="input-message"
                                        rows="5">{{ $donation->message }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <label class="custom-toggle">
                                        <input type="checkbox" name="is_anonym" value="1" {{ $donation->is_anonym ? 'checked':'' }}>
