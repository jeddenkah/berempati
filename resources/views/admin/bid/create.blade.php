        ...
        <div class="col-lg-6 col-7">
            ...
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('auction.show', $auction->id)}}">{{ $auction->name }}</a></li>
...
<div class="row justify-content-center">
    <div class="col-xl-8">
        <div class="card shadow">
            ...
            @endif
            <div class="card-body">
                <form action="{{ route('auction.bid.store', $auction->id) }}" method="POST"
                    ...
                    <a href="{{ route('auction.show', $auction->id) }}" class="btn btn-secondary float-right">Cancel</a>
                </form>
            </div>
        </div>
    </div>
