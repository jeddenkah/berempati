...
<div class="header-body text-center mb-7">
    <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
            <h1 class="text-white">Edit Lelang</h1>
...
<div class="row justify-content-center">
    <div class="bg-white col-12 rounded">
        <div class="row px-3 py-5">
            <div class="col-lg-4">
                <div class="card card-profile shadow">
                    <img src="{{ asset('storage/images/crowdfund/'.$auction->crowdfund->image) }}"
                        alt="Image placeholder" class="card-img-top" height="200px">

                    <div class="card-header text-center border-0 pt-4 pt-md-2 pb-0 pb-md-4">
                        <h2 class="mb-0"><a href="{{ route('crowdfund.showUser', $auction->crowdfund->id)}}"
                                class="stretched-link">{{ $auction->crowdfund->name }}</a></h2>
                        <div class="progress-wrapper mb-4">
                            <div class="progress-info">
                                ...
                                <div class="progress-percentage">
                                    <span>Rp. {{number_format($auction->crowdfund->totalDonation(),0,",",".")}}</span>
                                </div>
                            </div>
                            <div class="progress">
                                <div class="progress-bar bg-info" role="progressbar"
                                    aria-valuenow="{{$auction->crowdfund->totalDonationPercentage()}}" aria-valuemin="0"
                                    aria-valuemax="100"
            ...
            <div class="col-lg-8">
                <form action="{{ route('auction.updateUser', $auction->id) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input id="input-name" class="form-control" name="name" placeholder="Nama Barang"
                                    type="text" value="{{ $auction->name }}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" id="input-start-nominal" class="form-control"
                                        name="start_nominal" placeholder="Nominal" value="{{ $auction->start_nominal }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" name="target_date" id="input-target-date"
                                    value="{{ date('Y-m-d', strtotime($auction->target_date)) }}">
                            </div>
                        </div>
                    </div>
                    <hr class="my-4" />
